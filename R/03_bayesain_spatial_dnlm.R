...
first_stage_LAD_age_sepcific_list = readRDS("data/processed/02_model_data_ward22.rds")

first_stage_LAD_age_sepcific = first_stage_LAD_age_sepcific_list[[1]]
################################################################################
...
write_rds(cb_res, file = "output/03_predicted_inla_spatial_casecrossover.rds")

write_rds(df_complete, file = "output/03_df_complete_for_inla.rds")

write_rds(inla_model, file = "output/03_inla_model.rds")

write_rds(inla_res, file = "output/03_inla_result.rds")