...
MMT = read_rds("output/06_DPH_mmt_draws_by_ward_new_0_3.rds")
...
#------------------------------------------------------
out_dir = "output/07_cumlogRR_parts_2026_heatonly_newMMT/"
log_dir = "output/07_logs_2026_heatonly_newMMT/"
...
#save diagnostics
#------------------------------------------------------
write_rds(task_files, "output/07_cumlogRR_heatonly_newMMT_diagnostic.rds")
print(
  task_files %>% 
