...
tmap_save(
  combined_cold,
  filename = "figs/DPH_2026/10_DPH_figure_EM_Xcold_combined.png",
  width = 10,
  height = 6,
  units = "in",
  dpi = 600
...
tmap_save(
  combined_heat,
  filename = "figs/DPH_2026/10_DPH_figure_EM_Xheat_combined.png",
  width = 10,
  height = 6,
  units = "in",
  dpi = 600
